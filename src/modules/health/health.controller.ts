...
export class HealthController {
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Call root path and return app name', type: RootPathResDto })
  @Get()
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Check API and database status' })
  @Get('/health')
  @HealthCheck()
  public readiness(): Promise<HealthCheckResult> {
    return this.healthService.check([
      async (): Promise<HealthIndicatorResult> => this.appHealthIndicator.isHealthy('app'),
    ]);
  }
}
